...
This policy covers:
- The hosted MCP server at `mcp.octotrip.app/flights`

Out of scope:
- Third-party provider APIs that this server queries
- Third-party booking sites linked from results
